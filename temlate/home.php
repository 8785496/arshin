                        ...
                        <div class="col-md-12 homeservices1">
                            ...
                            <div class="col-md-3 portfolio-item">
                                <div class="text-center">
                                    ...
                                    <h3><a href="/request" data-toggle="tooltip" data-placement="right" title="Узнать стоимость работ">Геодезическое сопровождение строительства</a></h3>
                                    <p>
                                        - Вынос в натуру осей зданий и сооружений<br>
                                        - Вынос в натуру высотных отметок<br>
                                        - Осуществление исполнительной съемки<br>
                                        - Заключение о соответствии объекта строительства проектной
                                        документации
                                    </p>
                                </div>
                            </div>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>до 50 м<sup>2</sup></td>
                                    <td>от 10 000</td>
                                </tr>
                                <tr>
                                    <td>2</td>
                                    <td>Подготовка технического плана на индивидуальный жилой дом</td>
                                    <td>50-100 м<sup>2</sup></td>
                                    <td>от 11 000</td>
                                </tr>
                                <tr>
                                    <td>3</td>
                                    <td>Подготовка технического плана на индивидуальный жилой дом</td>
                                    <td>100-150 м<sup>2</sup></td>
                                    <td>от 12 000</td>
                                </tr>
                                <tr>
                                    <td>4</td>
                                    <td>Подготовка технического плана на индивидуальный жилой дом</td>
                                    <td>150-200 м<sup>2</sup></td>
                                    <td>от 13 000</td>
                                </tr>
                                <tr>
                                    <td>5</td>
                                    <td>Подготовка технического плана на индивидуальный жилой дом</td>
                                    <td>200-300 м<sup>2</sup></td>
                                    <td>от 14 000</td>
                                </tr>
                                <tr>
                                    <td>6</td>
                                    <td>Подготовка технического плана на индивидуальный жилой дом</td>
                                    <td>более 300 м<sup>2</sup></td>
                                    <td>от 15 000</td>
                                </tr>
                    ...
                    <div class="col-md-12">
                        <div class="col-lg-12">
                            <div class="text-center color-elements">
                                <h2>Контакты</h2>
                                <div>ООО "СИП Меридиан"</div>
                                <div>ОГРН 1164205051031 | ИНН 4205321980</div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 height-contact-element">
                                    <div class="form-group">
                                        ...
                                        <span class="text">
                                            <a href="tel:+73832136340">+7 (383) 213-63-40</a>,
